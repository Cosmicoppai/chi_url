...
logging.basicConfig(handlers=[logging.FileHandler(filename="../logs/url_stats.log", encoding="utf-8")],
                    level=logging.ERROR)
...
@router.get("/url_stats", tags=["url"], status_code=status.HTTP_200_OK)
